...
//       </div>
//       <div className="w-full h-fit flex lg:flex-row flex-col gap-[clamp(2rem,calc(-9.636rem+18.182vw),4rem)] mt-[clamp(48px,calc(36.364px+3.636vi),80px)] bg-primary px-[clamp(1.5rem,calc(0.773rem+3.636vi),3.5rem)] py-[clamp(2.5rem,calc(1.955rem+2.727vw),4rem)]">
//         <div className="lg:h-[42rem] md:h-[36rem] h-[24rem] w-full bg-secondary overflow-hidden rounded-[10px]">
//           <Canvas
//             style={{
...
//               fallback={
//                 <Html fullscreen>
//                   <div className="w-full h-full flex items-center justify-center inset-0 bg-white/95 backdrop-blur-xl">
//                     <div className="w-14 h-14 border-4 border-gray-300 border-t-accent rounded-full animate-spin"></div>
//                   </div>
//                 </Html>
//               }
...
//             {/* Simple approach - always enabled */}
//             <OrbitControls
//               ref={controlRef}
//               enabled={true}
//               minDistance={30}
...
//                 onClick={() => handleClick(selectedmodel)}
//                 key={index}
//                 className={`relative border-2 min-w-[clamp(56px,calc(47.273px+2.727vw),80px)] min-h-[clamp(56px,calc(47.273px+2.727vw),80px)] rounded-lg cursor-pointer overflow-hidden transition-all ease-in-out duration-300 ${
